...
When the application is first opened, the viewer is the first thing the viewer is presented with. Along the top there is a menu bar with two sub-menus: the first allows you to change which polytope is being rendered and the second allows you to close and re-open various windows.
